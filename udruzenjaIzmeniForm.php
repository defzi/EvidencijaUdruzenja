...
$UdruzenjaObject->UcitajUdruzenjePoId($stariId);
...
{
	$row=0;
	$StariId=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 0);
	$StariNaziv=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 1);
	$StaraAdresa=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 2);
	$StariGrad=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 3);
	$StariDatum=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 4);
	$StaraIDKategorije=$UdruzenjaObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaUdruzenja, $row, 5);
}
?>
...
<?php include 'delovi/desnoudruzenjaIzmeniForm.php';?>
</td>
<td style="width:1%;"></td>
</tr>
</table>
